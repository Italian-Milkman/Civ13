						...
						if (original_job_title == "Civilization A Citizen")
							...
							switch(rand_uni)
								...
								if (2)
									...
									equip_to_slot_or_del(new /obj/item/clothing/shoes/laceup(src), slot_shoes)
								if (3)
									equip_to_slot_or_del(new /obj/item/clothing/under/expensive(src), slot_w_uniform)
									equip_to_slot_or_del(new /obj/item/clothing/shoes/laceup(src), slot_shoes)
								if (4)
									equip_to_slot_or_del(new /obj/item/clothing/under/detective2(src), slot_w_uniform)
									equip_to_slot_or_del(new /obj/item/clothing/shoes/laceup(src), slot_shoes)
								if (5)
							...
							switch(rand_uni)
								if (1)
									equip_to_slot_or_del(new /obj/item/clothing/under/modern1(src), slot_w_uniform)
								if (2)
									equip_to_slot_or_del(new /obj/item/clothing/under/modern4(src), slot_w_uniform)
								if (3)
									equip_to_slot_or_del(new /obj/item/clothing/under/farmer_outfit(src), slot_w_uniform)
								if (4)
									equip_to_slot_or_del(new /obj/item/clothing/under/ww2/civ1(src), slot_w_uniform)
								if (5)
									equip_to_slot_or_del(new /obj/item/clothing/under/ww2/civ2(src), slot_w_uniform)
							var/rand_shoes = rand(1,3)
							switch(rand_shoes)
								if (1)
								...
								if (2)
									equip_to_slot_or_del(new /obj/item/clothing/shoes/leatherboots(src), slot_shoes)
								if (3)
									equip_to_slot_or_del(new /obj/item/clothing/shoes/jackboots/soviet(src), slot_shoes)
							if (prob(70))
								var/rand_hat = rand(1,4)
								switch(rand_hat)
									if (1)
										equip_to_slot_or_del(new /obj/item/clothing/head/sov_ushanka_new(src), slot_head)
									if (2)
										equip_to_slot_or_del(new /obj/item/clothing/head/ww2/sov_ushanka/nomads(src), slot_head)
									if (3)
