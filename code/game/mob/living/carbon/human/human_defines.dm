...
//	if you dont have that reagent in your blood.
	...
	map_storage_saved_vars  = "name;real_name;r_eyes;g_eyes;b_eyes;s_tone;r_skin;g_skin;b_skin;lip_style;age;b_type;w_uniform;shoes;belt;gloves;l_ear;r_ear;wear_id;r_store;l_store;head;toxloss;oxyloss;cloneloss;brainloss;internal_organs;organs;wear_mask;wear_suit;dna;species;back;gender;r_hand;l_hand;flavor_text"