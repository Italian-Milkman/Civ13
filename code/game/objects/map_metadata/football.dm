...
// Campaign
/obj/map_metadata/football/campaign
	ID = MAP_FOOTBALL_CMP
	match_duration = 17 MINUTES
	team1 = "Redmenia Utd."
	team2 = "Blugoslavia F.C."
	teams = list(
		//name, score, shorts color, short stripes color, shirt color, shirt sleeves color, shirt collar color, shirt v stripes, shirt h stripes
...
/obj/map_metadata/football/campaign/New()
	..()
	// Restore default teams for the campaign
	teams = initial(teams)